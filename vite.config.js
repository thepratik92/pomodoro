...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'TEMPO Pomodoro GT',
        short_name: 'TEMPO',
        description: 'A racing-inspired pomodoro timer with a pit board for your tasks.',
        start_url: '.',
        display: 'standalone',
      ...
      workbox: {
        ...
        // Fonts load from Google's CDN; cache them so offline keeps the look.
        runtimeCaching: [
          {
